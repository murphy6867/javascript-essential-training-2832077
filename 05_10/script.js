...
const navList = `
      ...
      <li><a href="#">User Infomation</a></li>
`;

const mainNav = document.createElement("nav");
mainNav.classList.add("nav-bar");
const navCon = document.createElement("ul");
navCon.innerHTML = navList;
mainNav.append(navCon);

document.querySelector(".site-title").append(mainNav);
